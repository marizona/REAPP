...
function Signup() {
    return (
        ...
        <div class="mx-auto lg:mt-64 md:mt-34 sm:mt-44 max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
        <form class="space-y-6" action="#">
            ...
            <div>
                ...
                <input type="password" name="password" id="password" placeholder="username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required/>
            </div>
            <div>
            ...
            <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                Already registered? <Link to="/signin" class="text-blue-700 hover:underline dark:text-blue-500"> Sign in Here</Link>
            </div>
        </form>
    </div>
    </div>
